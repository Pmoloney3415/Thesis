...
While in the absence of \ac{CBET}, it should lead to greater beam overlap, this increased overlap will result in more \ac{CBET}, which could reduce the uniformity of absorption.
...
There are many ways that the work presented in this chapter could be extended, through \textit{e.g.} improving the simulation platform improved to better reflect reality, or studying additional physics on the existing platform.
