...
A tabulated \texttt{Sesame} table of state was used for each material \cite{mchardy_introduction_2018} and a $P_{1/3}$ radiation transport algorithm was used with tabulated opacities and emissivities.
Thermal conduction was solved using a fully implicit scheme
