...
\begin{figure}[t!]
    ...
    $F_i$ is shorthand for the total field from all laser beams and sheets at pump depletion iteration $i$ and $M_{\text{CP}}$ is the caustic pump multiplier, described in Sec.~\ref{sec:energy_conserv_iters} of the $j^{\text{th}}$ energy conservation iteration.
...
To remedy this, additional energy conservation iterations can be performed, where a multiplier on the \ac{CBET} gain in caustics can be applied, $M_{\text{CP}}$, and varied to conserve laser energy.
...
For $N_b$ beamhen discretised on a grid (with approximately $N_g$ cells in each dimension), this 
